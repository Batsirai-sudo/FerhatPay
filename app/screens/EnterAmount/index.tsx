		...
		return (
			<View style={styles.createButton}>
				{false ? (
					...
					<BlueButton onPress={() => navigate('Confirm')} title={'Next'} testID="CreateTransactionButton" />
				)}
			</View>
		);
	};
		...
		return (
			<View style={{ width }} testID={'Transaction' + index}>
				...
				<TouchableOpacity
					...
					style={styles.fee}
				>
					<Text style={[styles.feeLabel, stylesHook.feeLabel]}>You'll pay</Text>
				...
				<TouchableOpacity
					...
					style={styles.fee}
				>
					<Text style={[styles.feeLabel, stylesHook.feeLabel]}>{'Our Fee'}</Text>
				...
				<TouchableOpacity
					...
					style={styles.fee}
				>
					<Text style={[styles.feeLabel, stylesHook.feeLabel]}>{'Fee percentage'}</Text>
				...
				>
					<KeyboardAvoidingView enabled={!Platform.isPad} behavior="position">
						...
						{/* <TouchableOpacity
							...
							style={styles.fee}
						>
							<Text style={[styles.feeLabel, stylesHook.feeLabel]}>{' fee'}</Text>
