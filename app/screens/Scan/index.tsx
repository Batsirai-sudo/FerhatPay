...
const ScanQRCode = () => {
	...
	const stylesHook = StyleSheet.create({
		...
		progressWrapper: { backgroundColor: colors.brandingColor, borderColor: colors.foregroundColor, borderWidth: 2 },
	});
	...
	return isLoading ? (
		...
		<View style={styles.root}>
			...
			<Camera ref={camera} style={styles.rnCamera} type={type} />
        ...
        <View style={[styles.openSettingsContainer, stylesHook.openSettingsContainer]}>
          <Text >{'loc.send.permission_camera_message'}</Text>
          ...
          <BlueButton title={'loc.send.open_settings'} onPress={openPrivacyDesktopSettings} />
			...
			<TouchableOpacity style={styles.closeTouch} onPress={() => {}}>
				<Image style={styles.closeImage} source={require('./close-white.png')} />
			</TouchableOpacity>
			<TouchableOpacity style={styles.imagePickerTouch} onPress={() => {}}>
				<Icon name="image" type="font-awesome" color="#ffffff" />
			</TouchableOpacity>
			{true && (
				<TouchableOpacity style={styles.filePickerTouch} onPress={() => {}}>
			...
			{true && (
				<View style={[styles.progressWrapper, stylesHook.progressWrapper]} testID="UrProgressBar">
					<Text whiteColor>Please continue scanning.</Text>
					<Text whiteColor>Scan Pay</Text>
				</View>
			)}
			{backdoorVisible && (
				<View style={styles.backdoorInputWrapper}>
					<Text>Provide QR code contents manually:</Text>
					<TextInput
