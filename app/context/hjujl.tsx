	...
	return (
		<SafeAreaView style={BaseStyle.safeAreaView} forceInset={{ top: 'always' }}>
			<Header
				...
				renderLeft={() => {
					return <Icon name="arrow-left" size={20} color={colors.primary} enableRTL={true} />;
				}}
				renderRight={() => {
					if (loading) {
			...
			<View style={styles.contain}>
				<View style={{ paddingHorizontal: 20, paddingVertical: 15 }}>
					<TextInput onChangeText={filterLanguage} placeholder={t('search_language')} value={country} />
				</View>
				<FlatList
