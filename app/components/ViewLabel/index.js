...
function ViewLabel(props) {
	...
	if (type === 'underline') {
		return (
			<View style={[styles.containerUnderLine, containerStyle]}>
				<View style={[styles.content, styles.contentUnderline, { borderColor: borderColor }, style]}>
					{children}
				</View>
				{error ? (
	...
	return (
		<View style={[styles.container, containerStyle]}>
			...
			<View style={[styles.content, styles.contentSolid, { borderColor: borderColor }, style]}>{children}</View>
			{error ? (
				<Text h6 h6Style={[styles.error, { color: colors.error }, errorStyle]}>
					{error}
				</Text>
